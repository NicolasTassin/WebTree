  ...
  return (
    <section>
     <button>
      ...
      <ul>
        ...
        <li>
          <p>
            ...
            this Agreement) refers to WebTree LLC, 7901 4th St N STE 300, St.
            Petersburg, FL 33702.
          </p>
        </li>
        <li>
        ...
        <li>
          <p>
            <strong>Website</strong> refers to WebTree, accessible from{" "}
            <a
              href="www.webtree.tech"
      ...
      <ul>
        <li>By email: info@webtree.tech</li>
      </ul>
